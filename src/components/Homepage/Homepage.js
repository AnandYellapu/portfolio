...
//       <Container>
//         <Row>
//           <Col md={7} className='backInUp'>
//             <h2 className='headtext'>Hello</h2>
//             <h2 className='nametext'>I'm Anand</h2>
//             <span className="underline"></span>
//             <Text className='backInUp' />
//             <div className="social-media-buttons backInUp">
//               <button
//                 onClick={() => {
//                   window.open("https://github.com/AnandYellapu");
//                 }}
...
//             </div>
//             <button
//               className="view-resume-button backInUp"
//               onClick={() => {
//                 window.open(googleDriveResumeLink);
//               }}
//             >
...
//             </button>
//           </Col>
//           <Col md={5} className='backInUp'>
//             <div className="imagedeveloper backInUp"></div>
//           </Col>
//         </Row>
//       </Container>
//     </div>
